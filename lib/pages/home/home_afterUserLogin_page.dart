...
//var seen = Set<ExpertDetails>();
      setState(() {
        ...
        topExpertList = allExpertlist
            ...
            .toList();
        favoriteList =
            allExpertlist.where((element) => element.isFavorite == 1).toList();
      });
    } else {
  ...
  toCreateFavorite(String userId, String userProfileId) async {
    ...
    try {
      Uri url =
          Uri.parse(Config.BASE_URL + '/api/user/favorite/create'); //url on web
  ...
  toDeleteFavorite(String userId, String user_profile_id) async {
    ...
    try {
      Uri url =
          Uri.parse(Config.BASE_URL + '/api/user/favorite/delete'); //url on web
      var response = await http.post(url,
          headers: <String, String>{
            'Content-Type': 'application/json; charset=UTF-8',
          },
                              ...
                              return InkWell(
                                ...
                                onTap: () {
                                  sendDataToExpertDetailsPage(
                                      _subCatModleTopStar.userProfileId
                                          .toString());
                                },
                                child: Container(
                                  width: double.infinity,
                                              ...
                                              Padding(
                                                ...
                                                child: ConstantWidget
                                                  ...
                                                  S.of(context).age +
                                                      ...
                                                      _subCatModleTopStar.age.toString() +
                                                      S.of(context).year,
